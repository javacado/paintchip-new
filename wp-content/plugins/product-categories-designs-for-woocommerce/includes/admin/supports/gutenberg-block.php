...
function pcdfwoo_register_guten_block() {
	...
	wp_register_script( 'pcdfwoo-block-js', PCDFWOO_VERSION_URL.'assets/js/blocks.build.js', array( 'wp-blocks', 'wp-i18n', 'wp-element', 'wp-block-editor', 'wp-components' ), PCDFWOO_VERSION, true );
