...
Contributors: BNGDesign
Tags: gateway, woocommerce, nmi, network merchants inc, merchant account, payment gateway, credit card
...
Securely accept credit cards directly on your WooCommerce store using NMI Gateway's three step redirect API.

== Description ==

**NMI Gateway Three Step Redirect API with support for secure payment method storage with customer vault.**
 
Securely Accept Credit Cards in WooCommerce with the NMI Gateway
 
The NMI Gateway For WooCommerce extension uses NMI's most advanced and secure integration method, their patented three step redirect API. By using this plugin you will be able to accept all major credit and debit cards. Your customers will be able to save their credit cards to their WooCommerce account for easy checkout on future orders. We are able to do this by leveraging the NMI Gateway's Customer Vault to securely save their credit card and pass back a token for storage in WooCommerce for future purchases. This is both extremely convenient for you clients, and is secure and PCI compliant for you.
 
![Alt](/screenshot-1.png "Enter your payment information")
...
- Process refunds and  voids directly in WooCommerce
...
**Save Credit Cards with NMI Gateway For WooCommerce PRO**
 
Your customers will be able to easily save and manage their cards when logged in. By having their preferred payment methods saved, customers are more likely to make return purchases since the checkout process is streamlined and fast.  Please note: your NMI account must have the Customer Vault enabled in order for your customers to save their payment methods.
...
3. Configure the plugin by going to WooCommerce > Settings > Checkout > NMI Gateway Three Step Redirect

== Screenshots ==

1. Entering your card information
2. Managing Saved Payment Methods
